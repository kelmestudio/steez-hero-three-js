                ...
                <div className="flex items-center justify-center pb-6 md:pb-12 border-b border-white/20">
                    ...
                    <div className="flex flex-col items-center gap-6 md:flex-row md:justify-between w-full">
                        ...
                        <div className="flex items-center gap-6 md:gap-6">
                            <Link href="https://tiktok.com/@steezdrink" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 md:gap-3 text-[14px] sm:text-[15px] md:text-[16px] font-bold text-white hover:text-[#F42254] transition-colors">
                                <svg width="20" height="22" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[20px] h-[22px] sm:w-[22px] sm:h-[24px] md:w-[22px] md:h-[24px] flex-shrink-0">
                            ...
                            <Link href="https://instagram.com/steezdrink" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 md:gap-3 text-[14px] sm:text-[15px] md:text-[16px] font-bold text-white hover:text-[#F42254] transition-colors">
                                <svg width="20" height="20" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[20px] h-[20px] sm:w-[22px] sm:h-[22px] md:w-[22px] md:h-[22px] flex-shrink-0">
                            ...
                            <Link href="https://facebook.com/steezdrink" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 md:gap-3 text-[14px] sm:text-[15px] md:text-[16px] font-bold text-white hover:text-[#F42254] transition-colors">
                                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[22px] h-[22px] sm:w-[24px] sm:h-[24px] md:w-[24px] md:h-[24px] flex-shrink-0">
                        ...
                        <Link href="/contacto" className="bg-white text-black px-6 sm:px-6 py-3 sm:py-3 rounded-full font-bold text-[14px] sm:text-[15px] md:text-[16px] hover:bg-[#F42254] hover:text-white transition-colors flex items-center justify-center gap-3 md:gap-3">
                            <svg width="20" height="16" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[20px] h-[16px] sm:w-[21px] sm:h-[18px] md:w-[21px] md:h-[18px] flex-shrink-0">
